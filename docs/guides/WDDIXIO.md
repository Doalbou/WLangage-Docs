...
1. Dans le répertoire d'installation de WDTRAD, copiez le sous-répertoire "Dictionary" (contenant le
...
Pour traduire les diérents éléments voulus depuis WINDEV, WEBDEV ou WINDEV Mobile :
